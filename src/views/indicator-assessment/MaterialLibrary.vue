      ...
      <div class="material-list">
        <div v-for="(item, index) in materials" 
          ...
          <div class="material-preview">
            <img v-if="item.type === 'image'" :src="item.preview" :alt="item.name" />
            <video v-else-if="item.type === 'video'" :src="item.preview" controls></video>
            <div class="delete-btn" @click.stop="handleDeleteMaterial(index)">×</div>
          </div>
